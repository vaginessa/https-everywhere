...
ApplicableList.prototype = {
  ...
  populate_menu: function(document, menupopup, weird) {
    ...
    var resetLabel = document.createElement('menuitem');
    var text = strings.getString("https-everywhere.prefs.reset_defaults");
    resetLabel.setAttribute('label', resetLabel);
    resetLabel.setAttribute('command', 'https-everywhere-menuitem-resetToDefaults');
    this.prepend_child(resetLabel);
